                  ...
                  <tr>
                    ...
                    <td>
                      <div class="input-group input-group-sm copy-link">
                        <input type="text" class="form-control input-link-formulario" value="<?= htmlspecialchars($linkAbsoluto) ?>" data-relative-link="<?= htmlspecialchars($linkAbsoluto) ?>" readonly>
